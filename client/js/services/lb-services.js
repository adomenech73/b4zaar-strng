    ...
    ['LoopBackResource', 'LoopBackAuth', '$injector', function (Resource, LoopBackAuth, $injector) {
      var R = Resource(
        ...
        {'id': '@id'},
        {
          ...
          // INTERNAL. Use Product.user() instead.
          "::get::product::user": {
            url: urlBase + "/products/:id/user",
            method: "GET"
          },

          // INTERNAL. Use Transaction.user() instead.
          "::get::transaction::user": {
            url: urlBase + "/transactions/:id/user",
            method: "GET"
          },
    ...
    ['LoopBackResource', 'LoopBackAuth', '$injector', function (Resource, LoopBackAuth, $injector) {
      var R = Resource(
        ...
        {'id': '@id'},
        {
           ...
           */
          "Near": {
            url: urlBase + "/products/Near",
            method: "POST"
          },

          // INTERNAL. Use Transaction.product() instead.
          "::get::transaction::product": {
            url: urlBase + "/transactions/:id/product",
            method: "GET"
          },
        }
      );
      ...
      R.user = function () {
        ...
        var action = TargetResource["::get::product::user"];
    ...
    ['LoopBackResource', 'LoopBackAuth', '$injector', function (Resource, LoopBackAuth, $injector) {
      var R = Resource(
        ...
        {'id': '@id'},
        {
          ...
          /**
           * @ngdoc method
           * @name lbServices.Transaction#prototype$__findById__dialogs
           * @methodOf lbServices.Transaction
           *
           * @description
           *
           * Find a related item by id for dialogs.
           *
           * @param {Object=} parameters Request parameters.
           *
           *  - `id` – `{*}` - PersistedModel id
           *
           *  - `fk` – `{*}` - Foreign key for dialogs
           *
           * @param {function(Object,Object)=} successCb
           *   Success callback with two arguments: `value`, `responseHeaders`.
           *
           ...
           * </em>
           */
          "prototype$__findById__dialogs": {
            url: urlBase + "/transactions/:id/dialogs/:fk",
            method: "GET"
          },

          /**
           * @ngdoc method
           * @name lbServices.Transaction#prototype$__destroyById__dialogs
           * @methodOf lbServices.Transaction
           *
           * @description
           *
           * Delete a related item by id for dialogs.
           *
           * @param {Object=} parameters Request parameters.
           *
           *  - `id` – `{*}` - PersistedModel id
           ...
           * This method returns no data.
           */
          "prototype$__destroyById__dialogs": {
            url: urlBase + "/transactions/:id/dialogs/:fk",
            method: "DELETE"
          },
          ...
          /**
           * @ngdoc method
           * @name lbServices.Transaction#prototype$__updateById__dialogs
           * @methodOf lbServices.Transaction
           *
           * @description
           *
           * Update a related item by id for dialogs.
           *
           * @param {Object=} parameters Request parameters.
           *
           *  - `id` – `{*}` - PersistedModel id
           ...
           * </em>
           */
          "prototype$__updateById__dialogs": {
            url: urlBase + "/transactions/:id/dialogs/:fk",
            method: "PUT"
          },
          ...
          /**
           * @ngdoc method
           * @name lbServices.Transaction#prototype$__get__dialogs
           * @methodOf lbServices.Transaction
           *
           * @description
           *
           * Queries dialogs of transaction.
           *
           * @param {Object=} parameters Request parameters.
           *
           *  - `id` – `{*}` - PersistedModel id
           ...
           * </em>
           */
          "prototype$__get__dialogs": {
            isArray: true,
            url: urlBase + "/transactions/:id/dialogs",
            method: "GET"
          },

          /**
           * @ngdoc method
           * @name lbServices.Transaction#prototype$__create__dialogs
           * @methodOf lbServices.Transaction
           *
           * @description
           *
           * Creates a new instance in dialogs of this model.
           *
           * @param {Object=} parameters Request parameters.
           *
           *  - `id` – `{*}` - PersistedModel id
          ...
          /**
           * @ngdoc method
           * @name lbServices.Transaction#prototype$__delete__dialogs
           * @methodOf lbServices.Transaction
           *
           * @description
           *
           * Deletes all dialogs of this model.
           *
           * @param {Object=} parameters Request parameters.
           *
           *  - `id` – `{*}` - PersistedModel id
          ...
          /**
           * @ngdoc method
           * @name lbServices.Transaction#prototype$__count__dialogs
           * @methodOf lbServices.Transaction
           *
           * @description
           *
           * Counts dialogs of transaction.
           *
           * @param {Object=} parameters Request parameters.
           *
           *  - `id` – `{*}` - PersistedModel id
           ...
           *  - `count` – `{number=}` -
           */
          "prototype$__count__dialogs": {
            url: urlBase + "/transactions/:id/dialogs/count",
            method: "GET"
          },
      ...
      /**
       * @ngdoc method
       * @name lbServices.Transaction#user
       * @methodOf lbServices.Transaction
       *
       * @description
       *
      ...
      R.user = function () {
        var TargetResource = $injector.get("User");
        var action = TargetResource["::get::transaction::user"];
        return action.apply(R, arguments);
      };

      /**
       * @ngdoc method
       * @name lbServices.Transaction#product
       * @methodOf lbServices.Transaction
       *
       * @description
       *
      ...
      R.product = function () {
        ...
        var action = TargetResource["::get::transaction::product"];
        return action.apply(R, arguments);
      };
